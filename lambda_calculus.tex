...
%\emnote{intuition}
Propositions in realizability models are interpreted via the set of their realizers. Following the Brouwer-Heyting-Kolmogorov, realizers of a formula are expected to \emph{compute} accordingly to the formula they realize. In particular, the interpretation of propositions is usually made in terms of \emph{saturated} set of terms, \emph{i.e.} closed under anti-reduction.
%

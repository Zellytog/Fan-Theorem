...
to logical principles adds a computational meaning to purely logical statements.\emnote{rephrase/add sth about capture the computational content of}
We follow this path by giving a computational meaning to Brouwer's Fan

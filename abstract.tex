...
In addition to intuitionistic reverse mathematics, the realizability approach
to logical principles adds a computational meaning to purely logical statements. We follow this path by giving a computational meaning to Brouwer's Fan
Theorem: building on recent work by Lubarsky and Rathjen, we construct a
realizability interpration of higher-order logic validating FT while refuting WKL. This interpretation relies on a $\lambda$-calculus extended with oracles while preserving a notion of continuity for realizers.

We then push this approach a step further to show the robustness of this realizability interpration by identifying, in the abstract and general setting of evidenced frames, sufficient computational conditions entailing FT.

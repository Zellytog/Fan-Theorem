...
\begin{proposition}[Saturated sequences]
  ...
  \left\{\left.(A_\enviro) \in \prod_{\enviro \in \Oracle} \SAT \right\vert \forall \enviro,\enviroT \in \Oracle, \enviro\infOr\enviroT \implies A_\enviro \subseteq A_\enviroT \right\}\]

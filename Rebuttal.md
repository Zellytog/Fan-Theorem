...
[?] mettre la bonne notation pour α∈𝕊 ?

We fixed the typo "Bool" instead of "Nat"
...
[?] Faut qu'on soit plus clair sur les notations/définitions pour les
sortes/data-types !
...
[ ? ] même remarque que Lionel pendant le séminaire non ?
...
[?] bonne remarque, c'est pas vraiment qu'elles sont introduites plus tard,
juste calculable plus tard, non ?
...
Yes, indeed, one acting on propositions, the other on evidences. 

[?] est-ce qu'on insiste sur "This is a very strict notion of morphisms, much
more than what is needed in practice to blabalbla..." ?

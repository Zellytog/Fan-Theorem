...
In this paper, we focus on the lowest principles of Brede-Herbelin hierarchy, namely Brouwer's Fan Theorem (\FT). Considering trees as prefix-closed sets of lists of booleans
%natural numbers,
...
\emnote{make it a bit more 1) a concrete model 2) abstraction to get a robust statement which the model actually satisfies}
...
Last, we identify in \Cref{s:robust} the computational features of our construction, namely a continuity property, strong existentials and unbounded search, and we provide a robust version of the validity of \FT using evidenced frames.

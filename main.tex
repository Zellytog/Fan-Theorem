...
the computational system has continuity, it can be extended with infinite path for any computable tree, it has explicit existential
and it has unbounded search.

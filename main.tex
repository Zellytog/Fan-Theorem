...
\begin{document}
\title[Oracles Just for Fan: A Robust Computational Interpretation of the Fan Theorem]{Oracles Just for Fan:\\ A Robust
...
Another interesting question arises when considering alternative versions of \FT. For example, it is possible to weaken the premisse that \emph{any bar must be uniform} by only considering bars on $\Pi_0^1$ trees or on computable trees.

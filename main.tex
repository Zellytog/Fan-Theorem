...
Using this realizability notion, the algorithm realizing $\WFT$ is an extensive search. For each integer $n$, the algorithm tests whether $n$ is a uniform bound. The algorithm terminates by meta-theoretic arguments, using both $\WKL$ in the meta-theory and the continuity of $\lambda$-calculus to get a contradiction.
...
\subsection{Fan Theorem \& Weak \Konig Lemma}

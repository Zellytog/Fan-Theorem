...
\begin{document}
\title{Oracles Just for Fan: A Realizability Interpretation Separating
...
We give a detailed construction of the realizability model: the logic used, the lambda-calculus and the realizability relation. We also give the standard theorem for a realizability model,
namely the adequacy, which guaranties that we construct a consistent theory.

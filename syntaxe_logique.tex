...
\begin{definition}[Semantic]\label{def:sem}
  ...
  \]
  by the usual set-theoretic interpretation. For example,
  \begin{multline*}
  ...
  \end{multline*}
  For the interpretation of $\Gamma\vdash \sortPred \termt : \Prop$, we put $\cod - \circ \sem{\Gamma\vdash \termt : S}$.

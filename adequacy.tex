...
\begin{theorem}[Adequacy]
  Let $\enviro \in \Oracle$, $\Gamma \in \Hctx$, $\termenv \models \Gamma$, for any $i = 1,\ldots,n$ a formula $\Gamma\vdash \varphi_i : \Prop$, a formula $\Gamma\vdash \varphi : \Prop$
%  \[\begin{cases}
%  \Gamma\vdash \varphi_i : \Prop \qquad \forall i = 1,\ldots,n\\
%  \Gamma\vdash \varphi : \Prop
%  \end{cases}\]
  and for all $i$, a term $t_i \realPP\varphi_i$ as well as $\Gamma\mid x_1:\varphi,\ldots,x_n:\varphi_n\vdash t:\varphi$.
%  \[\begin{cases}
...
The adequacy applies uniformly in $\enviro$, so it implies that $\realU$ is also adequate.
Thus, for any $\enviro\in\Oracle$, the sets
%\[\ThRealU \defeq \{ \varphi \in \Prop \mid \exists t \in \Lambda, t \realU \varphi\}\]
$\ThReal{\enviro} \defeq \{ \varphi \in \Prop \mid \exists t \in \Lambda, t \realP{\enviro}{} \varphi\}$ and
$\ThRealU \defeq \{ \varphi \in \Prop \mid \exists t \in \Lambda, t \realU \varphi\}$
